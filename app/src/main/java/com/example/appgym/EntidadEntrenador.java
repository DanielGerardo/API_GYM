...
public class EntidadEntrenador {
    ...
    public EntidadEntrenador(int idE,String nom,String apellido,String dire, int tel,int telA,String sexo, int edad,String fecha, byte[] foto, String User, String Pass, int activo){
        this.idE = idE;
        this.nom = nom;
